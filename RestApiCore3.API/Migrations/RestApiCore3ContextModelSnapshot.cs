...
{
    [DbContext(typeof(RestApiCore3Context))]
    partial class RestApiCore3ContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestApiCore3.API.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RestApiCore3.API.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RestApiCore3.API.Entities.Course", b =>
                {
                    b.HasOne("RestApiCore3.API.Entities.Author", "Author")
                        .WithMany("Courses")
