...
namespace RestApiCore3.API.DbContexts
{
    public class RestApiCore3Context : DbContext
    {
        public RestApiCore3Context(DbContextOptions<RestApiCore3Context> options)
           : base(options)
        {
        }
